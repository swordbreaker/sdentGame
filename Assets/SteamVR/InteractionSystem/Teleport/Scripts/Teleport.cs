...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
	{
		...
		private Quaternion offsetReticleTargetRotation = Quaternion.identity;
		...
		private void UpdatePointer()
		{
			...
			if ( hitTeleportMarker != null ) //Hit a teleport marker
			{
			    ...
			    _normal = normalToUse;
                destinationReticleTransform.rotation = Quaternion.FromToRotation(Vector3.up, normalToUse);
			...
			else //Hit neither
			{
				...
				offsetReticleTargetRotation = Quaternion.FromToRotation( Vector3.up, normalToUse );
				invalidReticleTransform.rotation = Quaternion.Slerp( invalidReticleTransform.rotation, offsetReticleTargetRotation, 0.1f );
		...
		private void TeleportPlayer()
		{
			...
			if ( teleportingToMarker.ShouldMovePlayer() )
			{
			    ...
			    Physics.gravity = -_normal * 9.81f;
			    player.transform.rotation = destinationReticleTransform.rotation;
			}
			else
			{
